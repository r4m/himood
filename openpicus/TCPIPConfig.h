...
#define MY_DEFAULT_IP_ADDR_BYTE4        (125ul)
...
#define MY_DEFAULT_SECONDARY_DNS_BYTE1	(89ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE2	(97ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE3	(140ul)
#define MY_DEFAULT_SECONDARY_DNS_BYTE4	(140ul)
